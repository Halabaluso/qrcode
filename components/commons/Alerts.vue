<template>
    <div v-show="props.show">
        <div v-show="props.type === `info`" class="alert alert-info">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-content2 text-sm">{{ props.msg }}</span>
            </div>
        </div>
        ...
        <div v-show="props.type === `warning`" class="alert alert-warning">
